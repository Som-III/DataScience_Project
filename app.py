...
class DataTransformationTrainingPipeline:
    ...
    def main(self):
        ...
        raw_filepath = Path("C:/Users/Som/coding/DataSc_project/artifacts/data_ingestion/raw.csv")
        
        logger.info(data_transformation_config.raw_file_path)
        data_transformation_obj.data_preprocess(raw_filepath)
        
        insurance_path = Path("C:/Users/Som/coding/DataSc_project/artifacts/data_transformation/insurance.csv")
